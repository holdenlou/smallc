...
#define PTR char * /* define Pointer type  David Luo 2025-06-04 */
#define int signed short /* make int 16 bit  David Luo 2025-06-04 */
...
char * addglb(char * sname,char id,char typ,int value);
char * addloc(char * sname,char id,char typ,int value);
